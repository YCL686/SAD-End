...
import com.example.sharablead.config.SensitiveWordInitConfig;
...
public class SensitiveFilterUtil {
    ...
    // 构造函数，初始化敏感词库
    private SensitiveFilterUtil() throws IOException {
        sensitiveWordMap = new SensitiveWordInitConfig().initKeyWord();
    }

    // 获取单例
    public static SensitiveFilterUtil getInstance() throws IOException {
        if (null == instance) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(sensitiveFilter.replaceSensitiveWord("花心,fuck!!!", 2, "*"));
    }
}
